...
import sys
sys.path.append("H:\Thesis\densecap")
# misc
...
parser.add_argument('--train_samplelist_path', type=str, default='densecap_vid/train_samplelist.pkl')
parser.add_argument('--save_valid_samplelist', action='store_true')
parser.add_argument('--load_valid_samplelist', action='store_true')
parser.add_argument('--valid_samplelist_path', type=str, default='densecap_vid/valid_samplelist.pkl')
...
# Data parallel
parser.add_argument('--dist_url', default='', type=str, help='url used to set up distributed training')
...
def main(args):
    ...
    for train_epoch in range(args.max_epochs):
        ...
        epoch_loss = train(train_epoch, model, optimizer, train_loader, args)
